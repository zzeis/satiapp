    ...
    <div class="container mx-auto px-4 py-8">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="border-b border-gray-100 dark:border-gray-700 p-6">
                ...
                <p class="text-gray-600 dark:text-gray-400 text-sm">Preencha os dados para registrar um novo equipamento no
                    sistema</p>
            </div>
            ...
            @if ($errors->any())
                <div
                    class="mx-6 mt-6 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-300 px-4 py-3 rounded-lg">
